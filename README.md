...
**训练配置**:Llama2-7B + LoRA(r=16, α=32),5 epochs / 5000 steps,FP16 混合精度
...
**AO 数据集难度说明**:候选池 16000+,物品标题含品牌+型号+SKU 编号(如 "red 73543"、"spr60050"),LLM 无法精确生成 ID;94% 测试用户为冷启动。即使训练 loss 收敛至 0.19,精确匹配 HR@1 仍为 0,印证原论文 AO 数据集效果低于 GM 的现象。
