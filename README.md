...
- **核心成果**：GM 数据集 HR@1 提升 233 倍(0.0233 vs 0.0000)；AO 数据集 HR@20 提升 67%(0.0460 vs 0.0275)
...
| ------ | --------------------- | ------ | -------- |
| HR@1   | 0.0233                | 0.0000 | +233 倍  |
| HR@5   | 0.0344                | 0.0000 | -        |
| HR@10  | 0.0367                | 0.0000 | -        |
| HR@20  | 0.0419                | 0.0000 | -        |
| MRR    | 0.0279                | 0.0001 | +278 倍  |
...
> 指标来自 `refined_metrics`(Answer Refinement 后的评估结果)。GM 数据集 DG 基线全为 0 是因为 DG 矩阵索引空间(0-112171)与 pipeline 的 id_mapping 空间(0-164879)不匹配导致跨空间查找失败。AO 数据集因物品池更大(38,396 候选)且物品标题含品牌/型号/尺寸，跨域推荐难度更高。
