...
**训练配置**:Llama2-7B + LoRA(r=16, α=32),5 epochs / 5000 steps,batch_size=1 + grad_accum=8,8bit QLoRA
**最终训练 loss**:0.1948 | **最佳 eval_loss**:0.3122
...
| MRR | 0.0000 | 0.0001 | — |
| fuzzy_HR@1 | 0.0080 | — | 仅 8/1000 样例含关键词重叠 |
| partial_HR@1 | 0.0040 | — | — |
...
- **结论**:AO 数据集本质难度高,即使 5 epochs 训练 loss 收敛至 0.19,精确匹配 HR@1 仍为 0,印证原论文中 AO 数据集效果低于 GM 的现象
