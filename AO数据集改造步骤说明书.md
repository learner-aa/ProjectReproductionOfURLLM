...
> 完成日期:2026-08-19
> 训练轮数:5 epochs
> 实际总耗时:约 7 小时 (训练 6.7h + 推理 0.15h + 评估 0.1h)
> **状态:✅ 全部完成**
...
| 指标 | 改造前 (3ep, profile) | 改造后 (5ep, retrieval+真实DG) | 变化 |
|------|----------------------|------------------------------|------|
| 精确 HR@1 | 0.0000 | **0.0010** | ↑ (1/1000) |
| fuzzy HR@1 | 0.0090 | 0.0020 | ↓ |
| OOD 率 | 49.95% | 50.00% | 持平 |
| eval_loss | 0.3550 | 0.4450 | — |
| 训练步数 | 3,000 | 5,000 | — |
| LoRA r/alpha | 16/32 | 8/16 | 对齐原论文 |
...
| 阶段 | 任务 | 预计时间 | 实际耗时 | 状态 | 关键产物 |
|------|------|---------|---------|------|---------|
| 0 | 准备与备份 | 30 分钟 | ✓ 已完成 | ✅ | git 提交 + 数据备份 |
| 1 | DG 向量接入与验证 | 1 小时 | ✓ 已完成 | ✅ | KNN 检索结果 (真实 DG 向量, k=1) |
| 2 | Prompt 改造 | 30 分钟 | ✓ 已完成 | ✅ | retrieval 模板 + 域标签修正 |
| 3 | 训练配置 | 30 分钟 | ✓ 已完成 | ✅ | lora_config_AO.yaml (r=8, alpha=16, 5ep+早停) |
| 4 | 训练(5 epochs) | 7-10 小时 | 6.7 小时 | ✅ | lora_weights_AO/final (train_loss=0.5316) |
| 5 | 推理 | 2-3 小时 | 8.8 分钟 | ✅ | test_predictions_AO.json (精确匹配 1/1000) |
| 6 | 评估 | 30 分钟 | 10 秒 | ✅ | evaluation_AO.json (HR@1=0.001) |
| 7 | 文档与前端同步 | 1-2 小时 | ✓ 已完成 | ✅ | 6 个文件更新 |
| **总计** | — | **13-18 小时** | **~7 小时** | **✅** | — |
